...
///
/// Simple Using FluttonShimerringAvatarCircle
///

class AvatarCircleLineScreen extends StatefulWidget
    with FluttonShimmeringHelpers {
  @override
  _AvatarCircleLineScreenState createState() => _AvatarCircleLineScreenState();
}

class _AvatarCircleLineScreenState extends State<AvatarCircleLineScreen> {
  bool _loading;
