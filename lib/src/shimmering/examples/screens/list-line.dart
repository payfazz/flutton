...
class ListLineScreen extends StatefulWidget with FluttonShimmeringHelpers {
  @override
  _ListLineScreenState createState() => _ListLineScreenState();
}

class _ListLineScreenState extends State<ListLineScreen> {
  bool _loading;
